...
class Consulta1 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        try {
        Fuel.get("https://apicubetechbridge.mexicocentral.cloudapp.azure.com/apiolap/ganancia_15_proyectos_o_alfabet")
    ...
    private fun loadUsers() {
        ...
        GlobalScope.launch(Dispatchers.IO) {
            try {
                ...
                val response = Fuel.get("https://apicubetechbridge.mexicocentral.cloudapp.azure.com/apiolap/ganancia_15_proyectos_o_alfabet").awaitString()
                ...
                withContext(Dispatchers.Main) {
                    ...
                    val listabtconsulta1 = gson.fromJson(response, Array<btconsulta1>::class.java).toList()
